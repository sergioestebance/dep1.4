...
/**
 * This is the model base class for the table "honorario1".
 * DO NOT MODIFY THIS FILE! It is automatically generated by giix.
 * If any changes are necessary, you must set or override the required
 * property or method in class "Honorario1".
 *
 * Columns in table "honorario1" available as properties of the model,
 * followed by relations of table "honorario1" available as properties of the model.
 *
 * @property integer $id
 ...
 */
abstract class BaseHonorario1 extends GxActiveRecord {
	...
	public static function label($n = 1) {
		return Yii::t('app', 'Honorario1|Honorario1s', $n);
	}

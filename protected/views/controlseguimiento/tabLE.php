		...
		$this->widget('bootstrap.widgets.BootTabbable', array(
			...
			'tabs'=>array(
				...
				array('label'=>'Secretaria RES AOD' , 'id' => 11,'content' => $this->renderPartial('//secretaria/ver_secretaria_resadodes', array('model' => $model->secretarias[1],),$this),),
				...
				array('label'=>'Resof contrato secr' ,'id' => 19,'content' => $this->renderPartial('//resofcontrato/ver_resofcontrato_sec', array('model' => $model->resofcontratos[0],),$this),),
				array('label'=>'Resof contrato cont' ,'id' => 20,'content' => $this->renderPartial('//resofcontrato/ver_resofcontrato_con', array('model' => $model->resofcontratos[1],),$this),),
			),
)); ?>

		...
		$this->widget('zii.widgets.jui.CJuiTabs', array(
			...
			'tabs' => array(
				...
				'Resolucion AOD' => array('id' => 9,'content' => $this->renderPartial('//resolucionadodes/ver_resolucionadode', array('model' => $model->resolucionadode,),$this),),
				'Secretaria RES AOD' => array( 'id' => 10,'content' => $this->renderPartial('//secretaria/ver_secretaria_resadodes', array('model' => $model->secretarias[1],),$this),),
				'Contraloria FIRMA AOD' => array('id' => 11,'content' => $this->renderPartial('//contraloria/ver_contraloria_adodes', array('model' => $model->contralorias[1],),$this),),

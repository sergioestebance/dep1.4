...
?>
	...
	<div class="row">
		...
		<?php echo $form->hiddenField($model,'proyecto_id',array(
														'size'=>45,
														'maxlength'=>45,
														'value'=>$model_proyecto->id)); ?>
		<?php echo CHtml::encode($model_proyecto->codigoProyecto); ?>											
		...
		<?php echo $form->hiddenField($model,'correlativo',array(
														'size'=>45,
														'maxlength'=>45,
														'value'=>$contador)); ?>
		<?php echo CHtml::encode($contador); ?>											

...
/**
 * This is the model base class for the table "resofcontrato".
 * DO NOT MODIFY THIS FILE! It is automatically generated by giix.
 * If any changes are necessary, you must set or override the required
 * property or method in class "Resofcontrato".
 *
 * Columns in table "resofcontrato" available as properties of the model,
 * followed by relations of table "resofcontrato" available as properties of the model.
 *
 * @property integer $id
 ...
 */
abstract class BaseResofcontrato extends GxActiveRecord {
	...
	public function tableName() {
		return 'resofcontrato';
	}

	public static function label($n = 1) {
		return Yii::t('app', 'Resofcontrato|Resofcontratos', $n);
	}

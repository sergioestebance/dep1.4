...
/**
 * This is the model base class for the table "procesoevaluacion".
 * DO NOT MODIFY THIS FILE! It is automatically generated by giix.
 * If any changes are necessary, you must set or override the required
 * property or method in class "Procesoevaluacion".
 *
 * Columns in table "procesoevaluacion" available as properties of the model,
 * followed by relations of table "procesoevaluacion" available as properties of the model.
 *
 * @property integer $id
 ...
 */
abstract class BaseProcesoevaluacion extends GxActiveRecord {
	...
	public static function label($n = 1) {
		return Yii::t('app', 'Procesoevaluacion|Procesoevaluacions', $n);
	}
